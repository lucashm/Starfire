...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Poor beefalo, at least wait for him to fall asleep!",
			GENERIC = "How can I shave that?",
			NOBITS = "Nothing to shave!",
		},
		STORE =
		{
			GENERIC = "Fully full!!",
			NOTALLOWED = "I don't think this thing can go there",
			INUSE = "Patiently waiting!",
		},
		RUMMAGE =
		{	
	...
	BATTLECRY =
	{
		GENERIC = "Starfire is on duty!",
		PIG = "Here piggy piggy!",
		PREY = "Poor little prey, die!",
		SPIDER = "Ughhh, die!",
	...
	DESCRIBE =
	{
		...
		{
			GENERIC = "It's me!",
			ATTACKER = "What a bad starfire...",
			MURDERER = "Murderer!",
			REVIVER = "Starfire loves all living things, and dead ones too...",
			GHOST = "Spookyfire!!",
		},
        PLAYER =
        {
		...
		BONESTEW = "It's so delicious I could marry it!",
		...
		FROGGLEBUNWICH = "The sandwich will look beautiful in my hair.",
		...
		KRAMPUS = "Is that the Second Santa?",
		KRAMPUS_SACK = "It's Second Santa's bag.",
		LEIF = "He's huge!",
		...
		MONSTERMEAT = "I don't think I should eat my opponents.",
